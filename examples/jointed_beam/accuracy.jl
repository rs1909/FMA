...
function accuracy()
    ...
    for it in [("0_0Nm",:red, "(a)", 0) ("1_0Nm",:blue, "(b)", 1) ("2_1Nm",:green, "(c)", 2.1) ("3_1Nm",:black, "(d)", 3.1)]
        ...
        SysName = "Beam-DFT-CAS4-tst-$(it[1])"
        ...
        plall = plot(pl..., yformatter = :scientific, margin=2mm, left_margin=10mm, bottom_margin=8mm, fontsize=12, tickfontsize=12, legend_font_pointsize=12, labelfontsize=12, titlefontsize=12, layout = @layout([a{0.4w,0.8h} b{0.4w,0.8h} c{0.4w,0.8h} d{0.4w,0.8h}]))
